...
from data import ModelNet40, ModelNetC
...
if __name__ == '__main__':
    ...
    def get_args():
        ...
        parser.add_argument(
            '--modelnet_root', type=str,
            default='data/modelnet40_ply_hdf5_2048')
        parser.add_argument(
            '--modelnetc_root', type=str,
            default='data/modelnet_c')
        parser.add_argument(
        ...
        parser.add_argument(
            '--test_batch_size', type=int, default=32, metavar='batch_size',
            help='Size of batch)')       
        parser.add_argument(
            '--eval', action='store_true',
            help='evaluate the model')
        parser.add_argument(
            '--eval_corrupt', action='store_true',
        ...
        parser.add_argument(
            '--ckpt', type=str, metavar='N',
            help='the trained checkpoint path')
